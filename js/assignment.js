...
function checkAgeAndRespond() {
    ...
    if (age >=18 && age <21) {
        responseEl = "You can vote, but you cannot purchase alcohol.";
    }
    else if (age > 18) {
        responseEl = "You cannot vote and you cannot purchase alcohol.";
    }
    else {
        responseEl = "You can vote and purchase alchol.";
    }
}
